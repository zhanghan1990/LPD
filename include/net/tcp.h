...
// LPD options and dtcp options

extern int sysctl_tcp_delayed_ack;
extern int sysctl_tcp_dctcp_enable;
extern int sysctl_tcp_dctcp_shift_g;
extern int sysctl_tcp_d2tcp_enable;
extern int sysctl_tcp_lpd_enable;
extern int sysctl_tcp_lpd_Fmax;
extern int sysctl_tcp_lpd_Dmax;
extern int sysctl_tcp_lpd_flowsize_enable;
extern int sysctl_tcp_lpd_deadline_enable;

extern int sysctl_tcp_dtcp_max;
extern int sysctl_tcp_dtcp_min;
extern int sysctl_tcp_dtcp_threshold_max;
extern int sysctl_tcp_dtcp_threshold_min;
extern int sysctl_tcp_dtcp_enable;
